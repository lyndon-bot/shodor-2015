...
// Global variables
var particleWidth = 10;     // the number of pixels wide each particle is.
var particleHeight = 10;    // the number of pixels tall each particle is.
var numParticles = 10;      // the number of particles to use.
var shouldBounce = false;   // says whether particles should bounce off each
                            //   other.
var particleColor = "blue"; // the CSS color of the particles.
